...
add_action('wp_print_footer_scripts', function () {
    ...
    ?>
    <script type="text/javascript" id="wpgs-script777-js-extra" data-no-defer data-no-optimize data-cfasync="false">var gsp_ajax_obj = {"ajax_url": <?php echo json_encode($ajax_url); ?>, "nonce": <?php echo json_encode($ajax_nonce); ?>};if (!window.gsp_ajax_obj) { window.gsp_ajax_obj = gsp_ajax_obj; }</script>
