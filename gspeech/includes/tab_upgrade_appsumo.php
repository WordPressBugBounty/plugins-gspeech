	...
	<div class="plans_holder">
		...
		<div class="gspeech_packages_wrapper">
						...
						<div class="pricing_table_row pricing_table_row_2">
							<ul class="feature_ul">
								...
								<li>
									...
									<span class="feature_text">Non AI Characters/М - 50k</span>
								</li>
								<li>
									<span class="icon_holder_p">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="currentColor" d="M64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V160H256c-17.7 0-32-14.3-32-32V0H64zM256 0V128H384L256 0zM112 256H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
									</span>
									<span class="feature_text">AI Characters/M - 0</span>
								</li>
			...
			<div class="gsp_package_wrapper gsp_package_personal" data-plan_id_m="" data-plan_id_y="">
				<div class="gsp_package_wrapper_inner">
					<div class="package_header">
						<h3 class="gsp_package_title">AppSumo Tier 1</h3>
						<div class="gsp_package_price">
							<div class="gsp_package_price_inner">
								<span class="price_span_c">$</span>
					...
					<div class="package_body">
						<div class="pricing_table_row pricing_table_row_2">
							<ul class="feature_ul">
								...
								<li>
									...
									<span class="feature_text">Non AI Characters/М - 500k</span>
								</li>
								<li>
									<span class="icon_holder_p">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="currentColor" d="M64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V160H256c-17.7 0-32-14.3-32-32V0H64zM256 0V128H384L256 0zM112 256H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
						...
						<div class="pricing_table_row pricing_table_row_3">
							<a class="product_button product_button_personal product_button_plan_1" href="https://appsumo.com/products/gspeech/#pricePlans" target="_blank">Sign Up Now</a>
						</div>
					</div>
				</div>
			</div>
			<div class="gsp_package_wrapper gsp_package_pro" data-plan_id_m="" data-plan_id_y="">
				<div class="gsp_package_wrapper_inner">
					<div class="package_header">
						<h3 class="gsp_package_title">AppSumo Tier 2</h3>
						<div class="gsp_package_price">
							<div class="gsp_package_price_inner">
								<span class="price_span_c">$</span>
					...
					<div class="package_body">
						<div class="pricing_table_row pricing_table_row_2">
							<ul class="feature_ul">
								...
								<li>
									...
									<span class="feature_text">Non AI Characters/М - 900k</span>
								</li>
								<li>
									<span class="icon_holder_p">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="currentColor" d="M64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V160H256c-17.7 0-32-14.3-32-32V0H64zM256 0V128H384L256 0zM112 256H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
									</span>
									<span class="feature_text">AI Characters/M - 100k</span>
								</li>
								<li class="pack_divider">
									<div class="pack_line"></div>
								</li>
								...
								<li>
									<span class="feature_icon_yes"><img src="<?php echo $img_path;?>checked.svg" /></span>
									<span class="feature_text">70 Languages</span>
								</li>
						...
						<div class="pricing_table_row pricing_table_row_3">
							<a class="product_button product_button_plan_2" href="https://appsumo.com/products/gspeech/#pricePlans" target="_blank">Sign Up Now</a>
						</div>
					</div>
				</div>
			</div>
			<div class="gsp_package_wrapper gsp_package_business" data-plan_id_m="" data-plan_id_y="">
				<div class="gsp_package_wrapper_inner">
					<div class="package_header">
						<h3 class="gsp_package_title">AppSumo Tier 3</h3>
						<div class="gsp_package_price">
							<div class="gsp_package_price_inner">
								<span class="price_span_c">$</span>
					...
					<div class="package_body">
						<div class="pricing_table_row pricing_table_row_2">
							<ul class="feature_ul">
								...
								<li>
									...
									<span class="feature_text">Non AI Characters/М - 1M</span>
								</li>
								<li>
									<span class="icon_holder_p">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="currentColor" d="M64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V160H256c-17.7 0-32-14.3-32-32V0H64zM256 0V128H384L256 0zM112 256H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
									</span>
									<span class="feature_text">AI Characters/M - 1M</span>
								</li>
								<li class="pack_divider">
									<div class="pack_line"></div>
								</li>
						...
						<div class="pricing_table_row pricing_table_row_3">
							<a class="product_button product_button_plan_3" href="https://appsumo.com/products/gspeech/#pricePlans" target="_blank">Sign Up Now</a>
						</div>
					</div>
				</div>
			</div>
			<div class="gsp_package_wrapper gsp_package_enterprise" data-plan_id_m="" data-plan_id_y="">
				<div class="gsp_package_wrapper_inner">
					<div class="package_header">
						<h3 class="gsp_package_title">AppSumo Tier 4</h3>
						<div class="gsp_package_price">
							<div class="gsp_package_price_inner">
								<span class="price_span_c">$</span>
					...
					<div class="package_body">
						<div class="pricing_table_row pricing_table_row_2">
							<ul class="feature_ul">
								...
								<li>
									...
									<span class="feature_text">Non AI Characters/М - 3M</span>
								</li>
								<li>
									<span class="icon_holder_p">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="currentColor" d="M64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V160H256c-17.7 0-32-14.3-32-32V0H64zM256 0V128H384L256 0zM112 256H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
									</span>
									<span class="feature_text">AI Characters/M - 2M</span>
								</li>
								<li class="pack_divider">
									<div class="pack_line"></div>
								</li>
						...
						<div class="pricing_table_row pricing_table_row_3">
							<a class="product_button product_button_plan_4" href="https://appsumo.com/products/gspeech/#pricePlans" target="_blank">Sign Up Now</a>
						</div>
					</div>
				</div>
			</div>
			<div class="gsp_package_wrapper gsp_package_enterprise" data-plan_id_m="" data-plan_id_y="">
				<div class="gsp_package_wrapper_inner">
					<div class="package_header">
						<h3 class="gsp_package_title">AppSumo Tier 5</h3>
						<div class="gsp_package_price">
							<div class="gsp_package_price_inner">
								<span class="price_span_c">$</span>
					...
					<div class="package_body">
						<div class="pricing_table_row pricing_table_row_2">
							<ul class="feature_ul">
								...
								<li>
									...
									<span class="feature_text">Unlimited – Exclusive Offer 🚀</span>
								</li>
								<li>
									<span class="icon_holder_p">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="currentColor" d="M64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V160H256c-17.7 0-32-14.3-32-32V0H64zM256 0V128H384L256 0zM112 256H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
									</span>
									<span class="feature_text">Non AI Characters/М - 8M</span>
								</li>
								<li>
									<span class="icon_holder_p">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="currentColor" d="M64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V160H256c-17.7 0-32-14.3-32-32V0H64zM256 0V128H384L256 0zM112 256H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
						...
						<div class="pricing_table_row pricing_table_row_3">
							<a class="product_button product_button_plan_5" href="https://appsumo.com/products/gspeech/#pricePlans" target="_blank">Sign Up Now</a>
						</div>
					</div>
				</div>
			</div>
